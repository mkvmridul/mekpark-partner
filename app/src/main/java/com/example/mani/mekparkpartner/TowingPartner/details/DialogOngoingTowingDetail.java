...
public class DialogOngoingTowingDetail extends DialogFragment {

    private String TAG = "OngoingTowingDialog";
    private View mRootView;

    private TowingBooking mTowingBooking;

    public DialogOngoingTowingDetail() {}
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
         ...
         mTowingBooking = (TowingBooking) getArguments().getSerializable("new_ongoing_booking");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.dialog_ongoing_towing_booking_details, container, false);
    ...
    private void setViewsAndClickListener() {
        ...
        mRootView.findViewById(R.id.towing_complete).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(),"Ongoing - Towing Complete",Toast.LENGTH_SHORT).show();
            }
        });
