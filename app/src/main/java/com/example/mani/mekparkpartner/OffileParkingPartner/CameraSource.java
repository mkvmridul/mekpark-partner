...
/* Manilal Kasera : Taken from github library "https://github.com/googlesamples/android-vision/blob/master/visionSamples/" +
         "barcode-reader/app/src/main/java/com/google/android/gms/samples/vision/barcodereader/BarcodeCaptureActivity.java"
 */
 ...
 * utilization is higher than you'd like_unseleted, then you may want to consider reducing FPS.  If the camera
...
public class CameraSource {
    ...
    private class FrameProcessingRunnable implements Runnable {
         ...
         * <p/>
         * If you find that this is using more CPU than you'd like_unseleted, you should probably decrease the
